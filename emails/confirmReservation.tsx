...
import { logo, logo1 } from "@/assets/images/images";
...
const ConfirmReservation: React.FC<Readonly<ThanksTemplateProps>> = ({ userName, nb_couverts, dateFormated }) => (
    <Html>
        <Head />
        <Preview>Le {dateFormated} pour {nb_couverts} </Preview>
                ...
                <Section>
                    <Row>
                        ...
                        <Column align="right" style={tableCell}>
                            <Text style={heading}>Réservation</Text>
                        </Column>
                    </Row>
                </Section>
                <Section>
                    <Text style={cupomText}>
                        Bonjour {userName}, voici le récapitulatif de votre réservation.
                        Ce mail n'est pas une confirmation de votre réservation, vous recevrez un message par sms pour vous confirmer votre réservation.
                    ...
                    <Row style={informationTableRow}>
                            ...
                            <Section>
                                <Row>
                                    <Column style={informationTableColumn}>
                                        <Text style={informationTableLabel1}>Nombre de couverts</Text>
                                    </Column>
                                </Row>

                                <Row>
                                    <Column style={informationTableColumn}>
                                        <Text style={informationTableLabel1}>Date</Text>
                                    </Column>
                                </Row>
                        ...
                        <Column style={informationTableColumn} colSpan={2}>
                            <Section>
                                <Row>
                                    <Column style={informationTableColumn}>
                                        <Text style={informationTableLabel1}  >{nb_couverts} couverts</Text>
                                    </Column>
                                </Row>

                                <Row>
                                    <Column style={informationTableColumn}>
                                        <Text style={informationTableLabel1}>{dateFormated}</Text>
                                    </Column>
                                </Row>
